// sockit_ghrd_fpgamem_system_mem_if_ddr3_emif_0_s0.v
...
`timescale 1 ps / 1 ps
module sockit_ghrd_fpgamem_system_mem_if_ddr3_emif_0_s0 (
	...
	altera_mem_if_sequencer_mem_no_ifdef_params #(
		...
		.AVL_SYMBOL_WIDTH (8),
		.MEM_SIZE         (24576),
		.INIT_FILE        ("sockit_ghrd_fpgamem_system_mem_if_ddr3_emif_0_s0_sequencer_mem.hex"),
		.RAM_BLOCK_TYPE   ("AUTO")
	) sequencer_mem (
	...
	sockit_ghrd_fpgamem_system_mem_if_ddr3_emif_0_s0_mm_interconnect_0 mm_interconnect_0 (
	...
	sockit_ghrd_fpgamem_system_mem_if_ddr3_emif_0_s0_irq_mapper irq_mapper (
		.clk        (avl_clk),                       //       clk.clk
