// sockit_ghrd_fpgamem_system_mm_interconnect_4.v
...
`timescale 1 ps / 1 ps
module sockit_ghrd_fpgamem_system_mm_interconnect_4 (
	...
	sockit_ghrd_fpgamem_system_mm_interconnect_4_router router (
	...
	sockit_ghrd_fpgamem_system_mm_interconnect_4_router_001 router_001 (
	...
	sockit_ghrd_fpgamem_system_mm_interconnect_4_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                           //       clk.clk
		.reset              (f2sdram_only_master_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sockit_ghrd_fpgamem_system_mm_interconnect_4_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                                      //       clk.clk
		.reset               (hps_0_f2h_sdram0_data_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sockit_ghrd_fpgamem_system_mm_interconnect_4_cmd_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                                      //       clk.clk
		.reset              (hps_0_f2h_sdram0_data_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sockit_ghrd_fpgamem_system_mm_interconnect_4_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                                           //       clk.clk
		.reset               (f2sdram_only_master_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sockit_ghrd_fpgamem_system_mm_interconnect_4_avalon_st_adapter #(
		.inBitsPerSymbol (258),
		.inUsePackets    (0),
		.inDataWidth     (258),
		.inChannelWidth  (0),
